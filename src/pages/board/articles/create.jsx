...
const CreateBoard = () => {
  ...
  return (
    <div style={{border: '1px solid black', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
        <div className="container" style={{border: '1px solid blue', width: '80%'}}>
            ...
            <section>
                <form onSubmit={onSubmitForm}>
                    <Select defaultValue="default" style={{ width: '100%', marginBottom: '20px' }} onChange={handleChange}>
                        <Option value="default">게시판을 선택해주세요.</Option>
                        <Option value="option1">Option1</Option>
                        <Option value="option2">Option2</Option>
                        <Option value="option3">Option3</Option>
                    </Select>
                    <Input style={{ width: '100%', marginBottom: '20px' }} placeholder="제목을 입력해주세요." />
                    {/* 내용 입력칸 + 에디터 기능 추가 */}
                    <div className="buttons" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                        <Button type="default" onClick={cancle}>취소</Button>
