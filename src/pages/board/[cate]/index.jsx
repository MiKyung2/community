...
import ModalLogin from '../../../components/Board/Modals/Modal_login';
...
const BoardPage = (props) => {
  return useObserver(() => {
    ...
    const fetchListData = async () => {
      ...
      state.page.total = nextData.body.totalElements
        ? nextData.body.totalElements
        : state.page.total;
    };
